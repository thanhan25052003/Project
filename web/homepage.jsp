<%-- 
    Document   : hompage
    Created on : Feb 23, 2024, 9:02:44 PM
    Author     : admin
--%>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form action="login" method="GET">
                        <button class="log ms-lg-auto" type="submit">Login</button>
                    </form>
                                ...
                                <div class="col mb-5">
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="cart?productId=${Product.id}">Add to cart</a></div>
                                        </div>
                                    </div>
                                </div>
                            </c:forEach>
